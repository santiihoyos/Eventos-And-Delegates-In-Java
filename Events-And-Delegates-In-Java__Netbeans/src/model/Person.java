...
public class Person {
    ...
    public void setLastName(String apellido) {
        ...
        listeners.stream().forEach((listener) -> {listener.onLastNameChange(this, apellido, this.lastName);});
    ...
    public void setAge(int edad) {
        ...
        listeners.stream().forEach((listener) -> {listener.onAgeChange(this, edad, this.age);});
        this.age = edad;
